...
_STRINGS: Dict[str, Dict[str, str]] = {
    ...
    "astro_need_node": {"en": "Node.js/npm was not found. Install Node.js (https://nodejs.org) to build the Astro site, or use the classic Static HTML Gallery instead.\n\nDetails: {err}",
                        "hu": "A Node.js/npm nem található. Telepítsd a Node.js-t (https://nodejs.org) az Astro weboldal építéséhez, vagy használd a klasszikus Statikus weboldalt.\n\nRészletek: {err}"},
